...
public class ArticleTHREEController {
    ...
    public void initialize() {
        ...
        webView.getEngine().load("https://autobuzz.my/2024/04/03/2024-ora-07-launched-in-malaysia-from-rm170k-byd-seal-rival-with-up-to-640km-range/");
    }
